  ...
  export default {
    setup() {
      ...
      const fetchAnswer = async () => {
        ...
        try {
          const VITE_GOOGLE_AI_STUDIO_API_KEY =
            "AIzaSyCeAaZdiXBXFWbNUnx-bziXMtqtAuqtz5Q";
          ...
          console.log({ error });
          errorMessage.value = "Sorry, there was an issue fetching the answer. Please try again later.";
        } finally {
